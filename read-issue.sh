...
SLACK_OUTPUT=$(claude -p "/slack-read ${CHANNEL}${TIME_HINT}. READ ONLY — extract tasks, do NOT investigate, fix, or take any action." --model opus --effort low $CLAUDE_FLAGS 2>&1 | tee -a "$LOG_FILE")
